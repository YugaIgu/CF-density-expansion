...
def Density_expansion_J_3(drift_func):
    ...
    def transition_density(x_t, x_0, θ, t):
        ...
        e_3 = - t**(3/2) * 6 * x_0[1] * (s - x_0[1] + x_0[1] ** 3 + x_0[0])**2 / (6 * ε**3 ) * Hermite_first[1]
...
def Density_expansion_J_4(drift_func):
    ...
    def transition_density(x_t, x_0, θ, t):
        ...
        e_4 = - t ** 2 * (18 * σ**2 * x_0[1] * (s + x_0[1] ** 3 - x_0[1] + x_0[0])) / (24 * ε ** 3) * H_RS  
        e_4 += - t ** 3 * 24 * σ**2 * x_0[1] * (s + x_0[1] ** 3 - x_0[1] + x_0[0]) / (120 * ε ** 4) * H_SS 
...
def Density_expansion_J_5(drift_func):
    ...
    def transition_density(x_t, x_0, θ, t):
        ...
        e_5 = t ** (3/2) * 6 * (- 3 * x_0[1] * ε * (s + x_0[1] ** 3 - x_0[1] + x_0[0]) * (α + γ * x_0[1] - x_0[0]) + (s + x_0[1] ** 3 - x_0[1] + x_0[0]) ** 3 -σ ** 2 * x_0[1] * ε) / (24 * ε ** 4) * Hermite_first[1] 
